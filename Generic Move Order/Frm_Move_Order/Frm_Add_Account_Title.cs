...
namespace Generic_Move_Order.Frm_Move_Order
{
    public partial class Frm_Add_Account_Title : Form
    {
        ...
        private void account()
        {
            ...
            account_title.company_id = int.Parse(cb_company.Text);
            account_title.department_id = int.Parse(cb_department.Text);
            account_title.location_id = int.Parse(cb_location.Text);
            account_title.account_id = int.Parse(cb_account.Text);
