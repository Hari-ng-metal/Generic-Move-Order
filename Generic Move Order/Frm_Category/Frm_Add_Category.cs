    ...
    public partial class Frm_Add_Category : Form
    {
        ...
        private void InsertCategory()
        {
            try
            {
                ...
                connect.con.Open();
                SqlCommand cmd = new SqlCommand("SP_InsertCategory", connect.con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@category", text_category.Text);
        ...
        private void UpdateCategory()
        {
            try
            {
                connect.DatabaseConnection();
                connect.con.Open();
                SqlCommand cmd = new SqlCommand("SP_UpdateCategory", connect.con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@id", edit_category.id);
                cmd.Parameters.AddWithValue("@category", text_category.Text);
                cmd.Parameters.AddWithValue("@status", label_status.Text);
                cmd.Parameters.AddWithValue("@logged_user", User.id);
                DataTable dt = new DataTable();
        ...
        private void AddOrEdit()
        {
            ...
            {
                text_category.Text = edit_category.category;
                label_status.Text = edit_category.status.ToString();
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            {
                if(text_category.Text == string.Empty || cb_status.Text == string.Empty)
                {
        ...
        private void CheckIfItemExist()
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@category", text_category.Text);
            cmd.Parameters.AddWithValue("@mode", "category");
            DataTable dt = new DataTable();
            dt.Load(cmd.ExecuteReader());
