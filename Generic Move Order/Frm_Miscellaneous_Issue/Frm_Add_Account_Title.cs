...
namespace Generic_Move_Order.Frm_Miscellaneous_Issue
{
    public partial class Frm_Add_Account_Title : Form
    {
        ...
        Frm_Issue frm;
        public Frm_Add_Account_Title(Frm_Issue _frm)
        {
            InitializeComponent();
            this.frm = _frm;
        }
        ...
        {
            issue_account_title.company_code = cb_company.Text;
            issue_account_title.department_code = cb_department.Text;
            issue_account_title.location_code = cb_location.Text;
            issue_account_title.account_code = cb_account.Text;
