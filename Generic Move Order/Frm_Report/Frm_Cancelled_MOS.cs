...
{
    public partial class Frm_Cancelled_MOS : Form
    {
        Connection connect = new Connection();
        public Frm_Cancelled_MOS()
        {
            InitializeComponent();
        }
        ...
        private void Frm_Cancelled_MOS_Load(object sender, EventArgs e)
        {
            CustomDatePicker();
            GetHistory();
        }
        ...
        public void GetHistory()
        {
            ...
            connect.con.Open();
            SqlCommand cmd = new SqlCommand("SP_GetMoveOrderCancellationHistory", connect.con);
