...
{
    public partial class Frm_Move_Order_Record_History : Form
    {
        Connection connect = new Connection();
        public Frm_Move_Order_Record_History()
        {
            InitializeComponent();
        }

        private void Frm_Move_Order_Record_History_Load(object sender, EventArgs e)
        {
            CustomDatePicker();
        }
        ...
        public void GetHistory()
        {
            ...
            connect.con.Open();
            SqlCommand cmd = new SqlCommand("SP_GetMoveOrderTransactionRecordHistory", connect.con);
