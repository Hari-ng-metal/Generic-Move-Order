...
{
    public partial class Frm_Loading_Checklist_Report : Form
    {
        Connection connect = new Connection();
        public Frm_Loading_Checklist_Report()
        {
            InitializeComponent();
        }

        private void Frm_Loading_Checklist_Report_Load(object sender, EventArgs e)
        {
            CustomDatePicker();
            GetChecklistReport();
        }
        ...
        public void GetChecklistReport()
        {
            ...
            connect.con.Open();
            SqlCommand cmd = new SqlCommand("SP_GetLoadingChecklistReport", connect.con);
        ...
        {
            Frm_Printing.printing.report_name = "LoadingChecklist";
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            ...
            Frm_Printing.printing.date_end = dateTimePicker2.Text;
