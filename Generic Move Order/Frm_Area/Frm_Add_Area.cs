...
namespace Generic_Move_Order.Frm_Area
{
    public partial class Frm_Add_Area : Form
    {
        ...
        Frm_Area frm;
        public Frm_Add_Area(Frm_Area _frm)
        {
            InitializeComponent();
            this.frm = _frm;
        }
        ...
        private void InsertArea()
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@area", text_area.Text);
        ...
        private void UpdateArea()
        {
            try
            {
                connect.DatabaseConnection();
                connect.con.Open();
                SqlCommand cmd = new SqlCommand("SP_UpdateArea", connect.con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@id", edit_area.id);
                cmd.Parameters.AddWithValue("@area", text_area.Text);
                cmd.Parameters.AddWithValue("@status", label_status.Text);
                cmd.Parameters.AddWithValue("@logged_user", User.id);
                DataTable dt = new DataTable();
        ...
        private void AddOrEdit()
        {
            if (edit_area.id > 0)
            {
                text_area.Text = edit_area.area;
                label_status.Text = edit_area.status.ToString();
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            {
                if (text_area.Text == string.Empty || cb_status.Text == string.Empty)
                {
        ...
        private void CheckIfItemExist()
        {
            ...
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@area", text_area.Text);
            cmd.Parameters.AddWithValue("@mode", "area");
            DataTable dt = new DataTable();
            dt.Load(cmd.ExecuteReader());
