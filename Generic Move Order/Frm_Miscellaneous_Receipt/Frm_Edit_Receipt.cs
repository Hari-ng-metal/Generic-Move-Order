...
{
    public partial class Frm_Edit_Receipt : Form
    {
        Connection connect = new Connection();
        Frm_Receipt frm;
        public Frm_Edit_Receipt(Frm_Receipt _frm)
        {
            InitializeComponent();
            this.frm = _frm;
        }
        ...
        {
            cb_code.Text = edit_receipt_item.item_code;
            label_id.Text = edit_receipt_item.id.ToString();
        ...
        {
            frm.dt_receipt.Rows[edit_receipt_item.index].Cells[0].Value = label_id.Text;
            frm.dt_receipt.Rows[edit_receipt_item.index].Cells[1].Value = cb_code.Text;
            frm.dt_receipt.Rows[edit_receipt_item.index].Cells[2].Value = text_desc.Text;
