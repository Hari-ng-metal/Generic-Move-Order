...
{
    public partial class Frm_Add_Receipt : Form
    {
        Connection connect = new Connection();
        Frm_Receipt frm;
        public Frm_Add_Receipt(Frm_Receipt _frm)
        {
            InitializeComponent();
            this.frm = _frm;
        }

        private void Frm_Add_Receipt_Load(object sender, EventArgs e)
        {
            cb_code.Select();
            cb_code.Focus();
            GetMasterlist();
        ...
        private void AddItem()
        {
            try
            {
                frm.dt_receipt.Rows.Add(label_id.Text, cb_code.Text, text_desc.Text, text_uom.Text, text_qty.Text, text_slab.Text, cb_farm.Text, text_production_date.Text);
            }
            catch (Exception ex)
            {
